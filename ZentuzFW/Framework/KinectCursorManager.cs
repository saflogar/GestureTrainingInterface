...
using zentuz.ZFXMLLog.GestureLog;
...
namespace Beginning.Kinect.Framework
{
    ...
    public class KinectCursorManager
    {
        ...
        public event EventHandler WaveGestureDetected;
        /// <summary>
        ...
        void _WaveGesture_GestureDetected(object sender, EventArgs e)
        {
            if (WaveGestureDetected != null)
            WaveGestureDetected(sender,e);
        }
